...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1275000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(19), 1300000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(19), 1312500, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(19), 1325000, 0x03006000},
  { {0, 0}, 0 },
};
